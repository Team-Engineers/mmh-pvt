      ...
      {TOKEN ? (
          ...
          <>
            <div className="bg-base-100  p-6 rounded-lg shadow-lg">
              <p className="text-lg font-semibold mb-4">
                🌟 Welcome to <strong>Make Money From Home!</strong> 🌟
              </p>
              ...
              <p className="text-sm mt-4">Best regards, Make Money From Home</p>
            </div>
          </>
        ) : (
          <div className="bg-base-100  p-6 rounded-lg shadow-lg">
        ...
        <>
          <h1 className="text-2xl mt-8 font-bold">
            Welcome to Make Money From Home!
          </h1>
          ...
          <p className="text-lg mt-6">
            Ready to boost your career? Join Make Money From Home today! Get
            Started
          </p>
        </>
      )}
