...
import SalaryModel from "../features/settings/team/components/SalaryModel";
          ...
          {
            {
              ...
              [MODAL_BODY_TYPES.DUPLICATE_LEADS]: (
                <DuplicateLeadModalBody
                  extraObject={extraObject}
                  closeModal={close}
                />
              ),
              [MODAL_BODY_TYPES.STATS_LEADS]: (
                <StatsLeadModalBody
                  extraObject={extraObject}
                  closeModal={close}
                />
              ),
              [MODAL_BODY_TYPES.CHANGE_TL]: (
                <AssignHRModel extraObject={extraObject} closeModal={close} />
              ),
              [MODAL_BODY_TYPES.ASSIGN_TL]: (
                <AssignHRModel extraObject={extraObject} closeModal={close} />
              ),
              [MODAL_BODY_TYPES.SEND_SALARY]: (
                <SalaryModel extraObject={extraObject} closeModal={close} />
              ),

              [MODAL_BODY_TYPES.ASSIGN_HR]: (
                <AssignHRModel extraObject={extraObject} closeModal={close} />
              ),
              [MODAL_BODY_TYPES.ASSIGN_LEADS]: (
                <AssignLeadModalBody
                  extraObject={extraObject}
                  closeModal={close}
                />
              ),
              [MODAL_BODY_TYPES.ASSIGN_TO_ACTIVE]: (
                <ActiveLeadModalBody
                  extraObject={extraObject}
                  closeModal={close}
                />
              ),
              [MODAL_BODY_TYPES.ASSIGN_TO_INACTIVE]: (
                <InActiveLeadModalBody
                  extraObject={extraObject}
                  closeModal={close}
                />
              ),
              [MODAL_BODY_TYPES.ASSIGN_TO_TOTAL]: (
                <TotalLeadModalBody
                  extraObject={extraObject}
                  closeModal={close}
                />
              ),
              [MODAL_BODY_TYPES.ASSIGN_TO_SINGLE]: (
                <SingleLeadModalBody
                  extraObject={extraObject}
                  closeModal={close}
                />
              ),
              [MODAL_BODY_TYPES.ASSIGN_TO_TL]: (
                <TLLeadModalBody extraObject={extraObject} closeModal={close} />
              ),
